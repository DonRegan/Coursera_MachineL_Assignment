...
## Required libraries
```{r}
library(caret) # required for the machine learning
library(rpart) 
library(rpart.plot);library(rattle) # for nice plots of classification trees
library(dplyr) #useful for data frame manipulation
library(ElemStatLearn) #useful for bagging 
library(randomForest)
library(AppliedPredictiveModeling) # to get the accuracy of the model fits using confusionMatrix
library(klaR) # for accuracy measure
```
